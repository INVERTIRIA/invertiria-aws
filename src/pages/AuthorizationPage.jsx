import { ArrowLeft, ArrowRight, DotIcon, Mails } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="z-2 w-fit flex gap-1 items-center px-3 py-2 rounded-2xl ring-1 ring-gray-300">
          ...
          <span className="text-xs font-medium">Error 403</span>
        </div>
        <h1 className="z-2 h2 text-center max-w-none">
          Esta página est&aacute; prohibida.
        </h1>
        <p className="z-2 text-base md:text-lg">
